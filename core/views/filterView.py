...
class FilterViewList(APIView):
    def get(self, request):
        dados = [{"sigla": "INC", "nome": "Inversão de Cores","descricao":"Realiza a inversão de cores transformando a imagem que está em escala de cinza em branco e preto. Para aplicar no processamento este filtro deverá ser enviada a sigla seguida de true.","exemplo":"{'1':{'tipoProcessamento':'INC','parametros':{}}}"},
